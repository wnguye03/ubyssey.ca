# Generated by Django 3.1.8 on 2021-05-21 01:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('players_team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='player_to_watch', to='sporttourney.sportsteamorderable')),
            ],
        ),
    ]
