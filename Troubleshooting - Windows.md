...
A; Try run npm rebuild node-sass, note that certain steps may take longer than expected so be patient. Read the error information. Based on previous experiences, you might be missing a Windows 8.1 sdk, or related Visual Studio C++ environment.
...
Ignore these warning messages. Fsevents was built for MacOS, this shouldn't have any actual impact on your installation.
...
Solution: Install windows sdk 8.1.
...
I encountered these warning messages: 
