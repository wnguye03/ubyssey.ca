...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('section', '0002_sectionpage_current_section'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('explicit_published_at', models.DateTimeField(help_text='Optional. Publication date which is explicitly shown to the reader. Articles are seperately date/timestamped for database use; if this field is blank front page etc. will display the database publication date.', null=True, verbose_name='Published At (Override)')),
